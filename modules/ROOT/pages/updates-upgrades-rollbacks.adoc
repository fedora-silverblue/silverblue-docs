...
NOTE: Currently, the default remote for Silverblue 30 is named `fedora`. If this is not the case for your system, you can find out the remote name by issuing: `ostree remote list`.
