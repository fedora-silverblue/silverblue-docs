...
to compose, deploy and update Silverblue. ostree operates in a similar manner
...
For Silverblue installs, ostree is responsible for deploying and updating the
...
makes it possible to install RPMs on Silverblue.
