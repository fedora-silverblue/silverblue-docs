...
*Silverblue does not provide a fully functional experience for manual partitioning, including separate home partitions.*

It is possible to make Silverblue work for manual 
partitioning, and some guidance is provided below. 
However, there are hazards involved, and you should only attempt 
to use this feature if you have done the necessary research, and are 
