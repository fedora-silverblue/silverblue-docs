...
To setup Flathub on {variant-name}, run 

 $ flatpak remote-modify --no-filter --enable flathub

If it does not exist, open the https://flatpak.org/setup/Fedora/[Flathub setup page for Fedora] and click the “Flathub repository file” button to download the Flathub configuration.
