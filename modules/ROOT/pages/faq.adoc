...
An alternative solution is xref:tips-and-tricks.adoc#_hiding-the-default-browser-firefox[hiding the default browser] and install https://flathub.org/apps/details/org.mozilla.firefox[Firefox from Flathub]
